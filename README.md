...
- [ ] 微信群入群
  ...
  - 艾特非实名的学生改成实名 `@jx`
- [ ] 微信群实名核对 `@xn`
    - 没选课/退课的同学原则上需要踢出课程，如果想要旁听，1.同学自己联系亓老师并获得允许，2.承诺每次课都出席并且每次作业包括大作业都交，这种情况可以暂留微信群+[xiong99](https://edu.matpool.com/login/)，出现任何一次旷课或没交作业立即踢出课程
    - 选课了但没进群的同学，把基本信息截图发到大群让认识的人拉进来，再给他们发一次邮件呼叫进群
- [ ] [xiong99](https://edu.matpool.com/login/) 注册
  - 助教给同学通过选课 `@zq`
...
>
> 提醒一下大家务必完成以下两个操作：
> 1. 请【修改备注名】（格式：班级姓名，例如25BA-姓名），助教们会仔细核对大家的选课信息，未实名的同学可能会被误踢哟～
> 2. 请同学们完成矩池云平台 (https://edu.matpool.com/login/) 的【注册】。登陆后在页面右上角实名选课，选课码为【86y96gDwG】。 注册和选课步骤参加下方pdf～

> 另：我们的上课信息为：周一10:00-12:00, 三教307教室，9月8日为第一次课，请大家准时参加～
...
- [ ] 未选上的同学原则上需要清退微信群+锯齿云，群里通知话术见下 `@全体`
...
- [ ] 在 [xiong99](https://edu.matpool.com/login/) 上发布 Task 0，给每个同学分配1个机时，
  - 作业内容：`@zq` 
    - 熟悉平台操作
...
- [ ] 快开课的前几天，每天提醒以下话术 `@zq+jx+xn`：
> 各位同学大家好，欢迎大家选修《深度学习与人工智能》。再次提醒一下大家：
> 1. 本周一为第一次课，上课地点为【三教307教室】。
> 2. 请同学们【务必】完成矩池云平台 (https://edu.matpool.com/login/) 的注册。登陆后在页面右上角【实名】选课，选课码为【0vymvpDG】。 
...
> 投骰子结果:
> A: `@zq`; B: `@jx`; O: `@xn`
> > 今年变成一学期的课程，按照hb师兄的最高指示助教应该再添加若干作业
...
- [ ] 课前准备 🅰️🅱️🅾️
 ...
 - 教学工具及可能的bug：
  ...
  - 课前签到
    ...
    - 打开 [xiong99](https://edu.matpool.com/login/) 签到，每次课第一节课间可以本人来找助教补签，之后不可以（建议第一周带一个纸质版签到表，防止签到出bug）
...
- [ ] 发布作业以及课后答疑 🅾️🅰️🅱️
  ...
  - 课前/课上发布作业-包括矩池云平台和微信群
    - 作业的截止时间定在【每周日】中午 12:00（防止大家熬夜赶作业）
  - 负责分发算力豆，原则上每次只发几颗
